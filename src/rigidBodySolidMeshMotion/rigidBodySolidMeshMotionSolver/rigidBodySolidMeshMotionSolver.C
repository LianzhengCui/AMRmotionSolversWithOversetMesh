...
#include "rigidBodySolidMeshMotionSolver.H"
...
namespace Foam
{
    defineTypeNameAndDebug(rigidBodySolidMeshMotionSolver, 0);

    addToRunTimeSelectionTable
    (
        motionSolver,
        rigidBodySolidMeshMotionSolver,
        dictionary
    );
}
...
Foam::rigidBodySolidMeshMotionSolver::bodyMesh::bodyMesh
(
    const polyMesh& mesh,
    const word& name,
    const label bodyID,
...
Foam::rigidBodySolidMeshMotionSolver::rigidBodySolidMeshMotionSolver
(
    const polyMesh& mesh,
    ...
    (
        ...
        (
            ...
            (
                IOobject
                (
                    "rigidBodySolidMotionSolver:meshSolver",
                    mesh.time().constant(),
                    mesh
                ),
...
Foam::rigidBodySolidMeshMotionSolver::curPoints() const
{
    return meshSolverPtr_->curPoints();
}


void Foam::rigidBodySolidMeshMotionSolver::solve()
{
...
bool Foam::rigidBodySolidMeshMotionSolver::writeObject
(
...
bool Foam::rigidBodySolidMeshMotionSolver::read()
{
...
void Foam::rigidBodySolidMeshMotionSolver::movePoints(const pointField& points)
{
    meshSolverPtr_->movePoints(points);
}


void Foam::rigidBodySolidMeshMotionSolver::updateMesh(const mapPolyMesh& mpm)
{
