...
template<class T>
void Foam::dynamicOversetRefineBalancedFvMesh::interpolate(Field<T>& psi) const
{
...
void Foam::dynamicOversetRefineBalancedFvMesh::interpolate(GeoField& psi) const
{
...
template<class GeoField>
void Foam::dynamicOversetRefineBalancedFvMesh::interpolate(const wordHashSet& suppressed)
{
    ...
    for (auto fldPtr : flds)
    {
        ...
        if (!suppressed.found(baseName(name)))
        {
            if (debug)
            {
                Pout<< "dynamicOversetRefineBalancedFvMesh::interpolate: interpolating : "
                    << name << endl;
            }
        ...
        else
        {
            if (debug)
            {
                Pout<< "dynamicOversetRefineBalancedFvMesh::interpolate: skipping : " << name
                    << endl;
            }
        }
    }
...
void Foam::dynamicOversetRefineBalancedFvMesh::correctBoundaryConditions
(
...
template<class Type>
Foam::tmp<Foam::scalarField> Foam::dynamicOversetRefineBalancedFvMesh::normalisation
(
...
template<class Type>
void Foam::dynamicOversetRefineBalancedFvMesh::addInterpolation
(
    fvMatrix<Type>& m,
...
template<class Type>
Foam::SolverPerformance<Type> Foam::dynamicOversetRefineBalancedFvMesh::solve
(
    fvMatrix<Type>& m,
...
) const
{
    ...
    if (!hasOverset)
    {
        if (debug)
        {
            Pout<< "dynamicOversetRefineBalancedFvMesh::solve() :"
...
template<class Type>
void Foam::dynamicOversetRefineBalancedFvMesh::write
(
    Ostream& os,
    const fvMatrix<Type>& m,
...
template<class GeoField>
void Foam::dynamicOversetRefineBalancedFvMesh::correctCoupledBoundaryConditions(GeoField& fld)
{
...
template<class GeoField>
void Foam::dynamicOversetRefineBalancedFvMesh::checkCoupledBC(const GeoField& fld)
{
